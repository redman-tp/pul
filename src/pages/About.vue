  ...
  <q-page>
    <main class="main">
      ...
      <section class="home" id="home">
        <img src="/pe/tees1.jpg" alt="" class="home__img" />
        <div class="home__container container grid">
          <div class="home__data">
            <h1 class="home__data-title">About Us</h1>

            <p class="home__data-title-d text-center">
      ...
      <section class="about-us q-mt-xl section" id="about">
      ...
      <section class="about section" id="tour">
        <div class="about__container container grid">
          ...
          <div class="about__img" data-aos="zoom-in">
            <img src="/pe/unsplash_4GpcEI8cqUk.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <section class="about section" id="tour">
        <div class="about__container flexer container grid">
          <div class="about__img" data-aos="zoom-in">
            <img src="/pe/unsplash_3kB63Vz7xVg.png" alt="" />
          </div>
          <div class="about__data">
      ...
      <section class="core-purpose">
        <div class="core-wrap container">
          <h2 class="text-center q-mt-xl">What We Believe</h2>
