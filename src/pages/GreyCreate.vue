  ...
  <q-page>
    <main class="main">
      ...
      <section class="home" id="home">
        <img src="/images/videoedit.jpg" alt="" class="home__img" />
      ...
      <section class="about section" id="tour">
        <div class="about__container container grid">
          ...
          <div class="about__img" data-aos="zoom-in">
            <img
              src="https://img.freepik.com/free-psd/3d-rendering-mike-working-computer_23-2149312576.jpg?w=2000&t=st=1688662836~exp=1688663436~hmac=c12dae682b57591b0c6cf76dae7c31c823d2fcff6c2806faf412ca6d65a09289"
              alt=""
            />
          </div>
        </div>
      ...
      <section class="about section" id="tour">
        <div class="about__container flexer container grid">
          <div class="about__img" data-aos="zoom-in">
            <img
              src="https://img.freepik.com/free-photo/representations-user-experience-interface-design_23-2150104516.jpg?w=2000&t=st=1688662871~exp=1688663471~hmac=292a3192d566b023f7179a3bf97843e3800b67b3ed793c1482e6097cd8f65b04"
              alt=""
            />
          </div>
          <div class="about__data">
      ...
      <section class="about section" id="tour">
        <div class="about__container container grid">
          ...
          <div class="about__img" data-aos="zoom-in">
            <img src="/pe/GC22 (1).jpg" alt="" />
          </div>
        </div>
      </section>

      <section class="values q-pb-lg">
        <h2 class="text-center q-mb-xl">Events we currently sponsor</h2>
        <div class="values-wrap container">
          <div class="card">
            <img src="/pe/guts talent show (1).jpg" alt="" />

            <p>Guts Talent Show</p>
          </div>
          <div class="card">
            <img src="/pe/sara.jpg" alt="" />

            <p>Sarauniya Carnival</p>
          </div>
          <div class="card">
            <img src="/pe/kaduna fashion.jpg" alt="" />

            <p>Kaduna Fashion Week</p>
          </div>
        </div>
      </section>
    </main>
