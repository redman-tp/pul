<template>
  <q-page class="metaverse">
    <main class="main">
      <!-- === HOME === -->
      <section class="home" id="home">
        <img
          src="/pe/boy-with-vr-glasses-play-with-virtual-videogame_207634-223 (1).webp"
          alt=""
          class="home__img"
        />
        ...
        <div class="home__container container grid">
          <div class="home__data">
            <h1 class="home__data-title">Into the Metaverse</h1>
            <p class="">
              Introducing new levels of social connection, mobility, and
              collaboration to a world of virtual work leveraging the metaverse.
            </p>
            <small
              >The best way to enjoy the metaverse is to be immersed inside the
              metaverse. Got an oculus headset? (Picture of Oculus
              Headset)</small
            >
          </div>
        </div>
      ...
      <section class="about section" id="about">
        <div class="about__container container grid">
          <div class="about__data">
            ...
            <a
              target="_blank"
              href="https://app.theoverlay.io/location/globe-theater"
              class="button"
              >Experience</a
            >
          </div>
        ...
        <div class="about__container container grid">
          ...
          <div class="experience__img grid">
            <iframe
              width="100%"
              height="315"
              src="https://www.youtube.com/embed/xMp4_tgXJAM"
        ...
        <div class="about__container flexer container grid">
          <div class="experience__img grid">
            <iframe
              width="100%"
              height="315"
              src="https://www.youtube.com/embed/liQ1lUHW3xQ"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      <section class="about section" id="about">
        <div class="about__container container grid">
          ...
          <div class="experience__img grid">
            <img src="/pe/murita.jpg" alt="" />
          </div>
        </div>
      </section>

      <section class="about addpad section" id="about">
        <div class="about__container flexer container grid">
          <div class="experience__img grid">
            <Splide :options="options" aria-label="Vue Splide Example">
              <SplideSlide>
                <iframe
                  width="100%"
                  height="315"
                  src="https://www.youtube.com/embed/rtLTZUaMSDQ"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
              ...
              <SplideSlide>
                <iframe
                  width="100%"
                  height="315"
                  src="https://www.youtube.com/embed/V6VsxcVpBVY"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
              ...
              <SplideSlide>
                <iframe
                  width="100%"
                  height="315"
                  src="https://www.youtube.com/embed/tc_ofY5WFw8"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
    ...
    <div class="follow">
      ...
      <div class="rowe">
        <div class="columnn">
          <img src="/pe/follow1.jpg" style="width: 100%" />
          <img src="/pe//follow2.jpg" style="width: 100%" />
        </div>
        <div class="columnn">
          <img src="/pe//follow6.jpg" style="width: 100%" />
          <img src="/pe/follow4.jpg" style="width: 100%" />
        </div>
        <div class="columnn">
          <img src="/pe/follow7.jpg" style="width: 100%" />
          <img src="/pe/follow5.jpg" style="width: 100%" />
        </div>
      </div>
    </div>
