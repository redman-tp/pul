  ...
  <main class="main">
    <article>
      ...
      <section
        ...
        id="home"
        aria-label="home"
        style="background-image: url('/pe/hero-bg.svg')"
      >
        <div class="container">
            ...
            <li>
              <div class="course-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title"
                      >The Complete Camtasia Course for Content Creators</a
                    >
                  </h3>
      ...
      <section
        ...
        aria-label="video"
        style="background-image: url('/pe/video-bg.png')"
      >
        <div class="container">
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title"
                      >Become A Better Blogger: Content Planning</a
                    >
                  </h3>
